      ...
      <div className="flex flex-col items-center gap-3 overflow-hidden bg-black/40 p-5 rounded-xl shadow-[0_8px_32px_rgba(0,0,0,0.3)">
        ...
        <div className="flex gap-5 items-start">
          ...
          <div className="flex flex-col gap-2 w-24">
            ...
            <button
              onClick={startGame}
              className="px-3 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg font-bold text-xs hover:opacity-90 transition-opacity"
            >
              新游戏
            </button>
            <button
              ...
              disabled={isGameOver}
              className="px-3 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-lg font-bold text-xs hover:opacity-90 transition-opacity disabled:opacity-50"
            >
              {isPaused ? '继续' : '暂停'}
            </button>
          </div>
